...
def hill_climbing(quaternions, bindings, mediana, points, rot_points, variancia):
...
#print mins
mediana, var = draw_kde(mins,'distribution_'+str(number_of_quat)+'.png')
#print quats
hill_climbing(quats, bindings, mediana, points, rots, var)
